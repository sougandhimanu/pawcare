...
public class VetActivity extends AppCompatActivity implements OnMapReadyCallback {

    CheckBox checkBoxOP;
    CheckBox checkBoxSurgery;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent homeIntent = new Intent(VetActivity.this, HomeActivity.class);
    ...
    private void setupUIComponents() {
        checkBoxOP = findViewById(R.id.checkBoxOP);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedDate == null || selectedTimeSlot == null || selectedLocationName == null) {
                    // If any of the selections are null, notify the user to make a selection
                    Toast.makeText(VetActivity.this, "Please select a date, time slot, and location.", Toast.LENGTH_LONG).show();
                } else {
                    // All selections are made, proceed with confirmation
    ...
    private void proceedToConfirmation() {
        ...
        Intent confirmIntent = new Intent(VetActivity.this, ConfirmationActivity.class);
    ...
    private class FetchPlacesTask extends AsyncTask<String, Void, String> {
        ...
        private void parseLocations(String json) throws JSONException {
            ...
            if (resultsArray.length() == 0) {
                ...
                Toast.makeText(VetActivity.this, "No pet-related places found nearby.", Toast.LENGTH_LONG).show();
            }
        }
    ...
    private void setupTypeCheckBoxes() {
        ...
        // Listener for the OP CheckBox
        checkBoxOP.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                selectedServices.add("OP");
            } else {
                selectedServices.remove("OP");
            }
        });

        // Listener for the Surgery CheckBox
        checkBoxSurgery.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                selectedServices.add("Surgery");
            } else {
                selectedServices.remove("Surgery");
            }
        });
    }
